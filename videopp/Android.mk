...
libmm-vidpp-inc          += $(call project-path-for,qcom-display)/libgralloc
...
libmm-vidpp-inc          += $(call project-path-for,qcom-display)/libqdutils
libmm-vidpp-inc          += $(call project-path-for,qcom-display)/libcopybit
